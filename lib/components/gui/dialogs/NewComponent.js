...
var NewComponentDialog = function NewComponentDialog(_ref) {
  ...
  return _react.default.createElement(_dialog.default, null, function (_ref2) {
    ...
    return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Enter a name for your Component"), _react.default.createElement("div", {
      style: {
        width: '80%',
        maxWidth: '500px'
      }
      ...
      onClick: function onClick(e) {
        dispatch((0, _actions.addComponentTree)(scopeDialogFields.name, component));
        setVisibility(false);
      }
    }, "Create Component"), _react.default.createElement("button", {
      type: "button",
      style: {
        backgroundColor: 'teal',
        padding: '10px 20px',
