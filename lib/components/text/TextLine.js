  ...
  _createClass(TextLine, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          c = _this$props2.classes,
          _ref = _this$props2._ref;
      return _react.default.createElement("div", {
        className: c.container
      }, _react.default.createElement("div", {
        className: focused ? c.animBarFocused : c.animBarBlurred
      }), _react.default.createElement("label", {
        htmlFor: name,
        className: !focused && value == '' ? c.labelBlurred : c.labelFocused
...
var StyledComponent = (0, _reactJss.default)(_textStyles.default)(TextLine); // We forward the ref to the TextLine using the _ref prop. 
